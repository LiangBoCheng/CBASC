...
def get_parser():
    ...
    parser.add_argument('--dataset', default='RefSegRS', help='rrsisd, RefSegRS, or RISBench')
    ...
    parser.add_argument('--model_id', default='CBASC', help='name to identify the model')
    ...
    parser.add_argument('--refer_data_root', default='/root/user/cs_tcci_liangbocheng/RIS_Datasets/RRSIS-D/', help='REFER dataset root directory')
    parser.add_argument('--resume', default='', help='resume from checkpoint')  # ./checkpoints/model_last_CBASC.pth
